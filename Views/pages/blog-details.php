...
<body>
    ...
    <section class="blog-hero spad set-bg" data-setbg="../Resource/img/blog/blog-hero.jpg">
        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <a href="#" class="blog__details__option__item">
                                        ...
                                        <div class="blog__details__option__item__img">
                                            <img src="../Resource/img/blog/prev.jpg" alt="">
                                        </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <a href="#" class="blog__details__option__item blog__details__option__item--right">
                                        ...
                                        <div class="blog__details__option__item__img">
                                            <img src="../Resource/img/blog/next.jpg" alt="">
                                        </div>
                                        <div class="blog__details__option__item__text">
                                            <h6>Looking for Music & Sounds for my new Android...</h6>
                                            <span>Nov 27, 2019</span>
                            ...
                            <?php foreach ($HomeController->VerComentarios() as $key) : ?>
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="blog__details__recent__item">
                                        <img src="../Resource/img/blog/ri-3.jpg" alt="">
                                        <h5><?php echo $key->__GET('Comentario')?></h5>
                                        <span><?php echo  $key->__GET('Fecha')?></span>
                                    </div>
                                </div>
                  <?php endforeach ?>
                            </div>
                        ...
                        <div class="blog__details__comment">
                            ...
                            <form action="../../Actions/Comentario/EnviarComentario.php" method="POST">
                                ...
                                <textarea name="comentario" placeholder="Comment"></textarea>
